# 🌐 Convertia – Smart Unit Converter
...
## 🧠 How It Works
1. Choose a conversion type (Length, Weight, or Temperature)
2. Enter a value
3. Select units to convert from and to
4. Get instant results displayed dynamically
